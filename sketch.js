...
let playerAnis = {
  idle:     { row: 0, frames: 13, frameDelay: 8 },
  run:      { row: 1, frames: 8,  frameDelay: 4 },
  jump:     { row: 4, frames: 4,  frameDelay: Infinity, frame: 0 },
  attack:   { row: 2, frames: 10, frameDelay: 2 },
  hurtPose: { row: 5, frames: 6,  frameDelay: Infinity },
...
function preload() {
  playerImg = loadImage("assets/adventurer_sprite_sheet_v1_1.png");
